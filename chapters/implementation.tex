...
\WKSAY{I need to write more about burst. address and request wait witness in master agent is unreachable because it is only one master. slave wait constraint is not necessary in master agent.}
